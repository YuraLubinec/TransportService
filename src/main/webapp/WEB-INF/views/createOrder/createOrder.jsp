...
<div class="container-fluid">
	...
	<div class="col-md-12">
				...
				<form:form action="" method="POST" modelAttribute="orders" class="form-group" id="orderForm">
					<div class="col-md-12 col-lg-12 no-padding">
						<div class="col-md-9 col-lg-9 no-padding">
							<label class="">Вид робіт</label>
							<form:select id="typeOfWork" path="workType" items="${workTypeFromSap}" class="form-control orderInput" data-placeholder="work" itemLabel="name"
								itemValue="id" cssErrorClass="error form-control" />
							<form:errors path="workType" class="help-block with-errors" cssErrorClass="" />
						</div>
						<div class="col-md-2 col-lg-2 col-md-offset-1 col-md-offset-1 no-padding">
							<label class="">Кількість</label>
							<form:select id="countOrder" path="count" class="form-control orderInput text-center">
					...
					<div class="form-inline no-padding col-md-12">
						<div class="col-md-6 form-group no-padding-left">
							<div class="input-group col-md-12 ">
								<span class="input-group-addon"><span class="glyphicon glyphicon glyphicon-time"></span></span>
								<form:input id="startTime" required="required" path="time" class="form-control" placeholder="початок" readonly="true" cssErrorClass="error form-control" />
						...
						<div class="col-md-6 form-group no-padding text-left">
							<div class="input-group col-md-12 ">
								<span class="input-group-addon"><span class="glyphicon glyphicon glyphicon-time"></span></span>
								<form:input id="endTime" required="required" path="time_end" class="form-control" placeholder="кінець" readonly="true"
									cssErrorClass="error form-control" />
					...
					<form:input id="mobile_phone_number" required="required" path="mobile_phone_number" class="form-control orderInput" placeholder="+38011111111"
						cssErrorClass="error form-control" />
					...
					<form:input id="second_email" path="second_email" class="form-control orderInput" placeholder="__.__@oe.if.ua" cssErrorClass="error form-control" />
					<form:errors path="second_email" class="help-block with-errors" cssErrorClass="" />

					<br>

					<div class="">
						<button id="" type="submit" class="btn btn-success paymentApprove form-control pull-down">
							Замовити <span class="glyphicon glyphicon-ok"></span>
						</button>
					</div>
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<c:forEach items="${workTypeFromSap}" var="workType">
									<tr id="${workType.id}">
										<td><c:out value="${workType.name}"></c:out></td>
										<td><c:out value="${workType.price}. грн">
											</c:out></td>
										<td><c:out value="${workType.time/60} год.">
											</c:out></td>
									</tr>
								</c:forEach>
							</tbody>
		...
		<c:if test="${param.message == true}">
			...
			<div class="row">
				<div class="alert alert-success col-md-4 col-md-offset-4">Ваше замовлення оформлено, очікуйте квитанцію для оплати на Вашу електронну пошту!</div>
			</div>
